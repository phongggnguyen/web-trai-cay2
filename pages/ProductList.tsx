...
const ProductList: React.FC<ProductListProps> = ({ onNavigate, onProductClick }) => {
      ...
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            <button onClick={() => onNavigate(Page.HOME)} className="hover:text-primary hover:underline">Trang chủ</button>
