export const heroSlides = [
    {
        ...
        ctaPrimary: "Mua Cam Ngay",
        ctaSecondary: "Xem Khuyến Mãi",
        color: "from-orange-500 to-yellow-500", // Gradient cho nút/tag
        overlayColor: "from-orange-900/40 via-transparent to-transparent", // Overlay nền
    ...
    },
    {
        ...
        ctaPrimary: "Thử Dâu Ngay",
        ctaSecondary: "Combo Quà Tặng",
        color: "from-red-500 to-pink-500",
        overlayColor: "from-red-950/40 via-transparent to-transparent",
    ...
    },
    {
        ...
        ctaPrimary: "Chọn Sống Xanh",
        ctaSecondary: "Tìm Hiểu Thêm",
        color: "from-primary to-green-400",
        overlayColor: "from-green-950/40 via-transparent to-transparent",
